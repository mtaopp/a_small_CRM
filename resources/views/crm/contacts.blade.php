        ...
        <div class="place-self-center w-full">
            ...
            <div class="block w-full text-lightblue">
                <div class="flex justify-between mb-4">
                    ...
                    <a href="{{ route('create.contact') }}"><x-icons.edit-icon width="4rem"/></a>
                </div>
                <x-card2 twWidth="w-full block">
                    <table class="w-full">
                        ...
                        <tr class="">
                            ...
                            <td class="px-2"><a href="{{ route('contact', ['id' => $contact->id]) }}"><x-icons.clipboard-icon width="1.2rem"/></a></td>
                        </tr>
